...
def AutoLevel(xxx_todo_changeme):
	(channel, minimum, maximum, gain) = xxx_todo_changeme
...
def MaxImage(xxx_todo_changeme1):
	(red, green, blue) = xxx_todo_changeme1
	return numpy.maximum(numpy.maximum(blue, green), red)

# Stage 9 - Exclude the unwanted ares on a channel
def ExcludeSections(xxx_todo_changeme2):
	(channel, maxImage, black) = xxx_todo_changeme2
	sectionOnly = channel[:]
...
def BuildView(xxx_todo_changeme3):
	(red, green, blue, black) = xxx_todo_changeme3
