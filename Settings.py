...
# Threading settings
processingThreads = 8				# Number of processing threads to work with

# Camera settings
imageWidth   = 160					# Camera image width
imageHeight  = 120					# Camera image height
frameRate    = 10 # was five			# Camera image capture frame rate
...
simulationDrivePower = 0.3			# Speed multiplier for the simulation mode
simulationSteeringGain = 1.0		# Override for the steering gain in simulation mode
simulationYetiSpeed = 0.78			# Override for the YetiBorg speed in simulation mode (used for distance calculations)
simulationLagFrames = 0				# Number of frames to delay the processing by to simulate camera lag
...
laneWidth = 0.09					# Width of the coloured lanes in meters
...
# PID control values
Kp0 = 0.1 # was 0.16							# P term for d0 input (Offset)
Ki0 = 0.00							# I term for d0 input (Offset)
Kd0 = 0.1 # was 0.20							# D term for d0 input (Offset)
Kp1 = 0.055 # was 0.004							# P term for d1 input (Angle)
Ki1 = 0.00							# I term for d1 input (Angle)
Kd1 = 0.1 # was 0.004							# D term for d1 input (Angle)
Kp2 = 0.00							# P term for d2 input (Curvature)
Ki2 = 0.00							# I term for d2 input (Curvature)
Kd2 = 0.00							# D term for d2 input (Curvature)
clipI = 40 # was 100							# Clipping limit for the integrators
...
stuckOverrideSeconds = 1.0			# Number of seconds to reverse for when stuck
stuckHuntSeconds = 0.6				# Number of seconds to hunt for the track after reversing when stuck
